...
- `agents/langgraph/examples/guardrailed_agent/tests/behavioral/conftest.py`
...
- `agents/langgraph/examples/guardrailed_agent/tests/behavioral/` (single tool: `check_balance` + NeMo Guardrails proxy)
